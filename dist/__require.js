...
export default function require(library) {
  ...
  return import(`https://srv.divriots.com/packd/lit,lit-html@next-major?env.NODE_ENV=development`).then((module) => module['packd_export_'+idx]);
}